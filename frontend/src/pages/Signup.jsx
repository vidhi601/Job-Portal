        ...
        <div>
            ...
            <div className="flex justify-center items-center min-h-screen px-4"
                ...
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-2xl w-full max-w-sm space-y-4 border border-white/40">
                    ...
                    <h2 className="text-2xl font-bold text-center text-white drop-shadow">Create Account</h2>
                    <p className="text-center text-white/70 text-sm">Join HireHub today</p>
